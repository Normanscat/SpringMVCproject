		...
		<div class="form-input">
			<div class="form-left">
				<div class="input-group ">
					<label class="input-label">用户名称：</label> <input id="username"
						...
						placeholder="请输入您的用户名！" value="${User.name }">
				</div>
				<div class="input-group ">
				...
				<div class="input-group ">
					<label class="input-label">重复密码：</label> <input id="repeatPassword"
						...
						maxlength="20" placeholder="请输入您的确认密码！" value="${User.password }">
				</div>
				<div class="input-group ">
				...
				<div class="input-group">
					...
					<select class="multiple-select" name="hobby" multiple="multiple"
						size="4">
						<c:forEach items="${hobby }" var="item" varStatus="status">
			...
			<div class="form-right">
				<div class="upload-avatar ">
					<img src="${pageContext.request.contextPath }/file/${User.image }"
						id="myimage" name="avatar" width="200px" height="200px" />
					<p>
