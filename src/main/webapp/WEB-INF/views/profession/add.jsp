...
<section class="main-panel">
	...
	<form name="userForm"
		action="${pageContext.request.contextPath }/profession/add" method="post"
		class="form">
			...
			<div class="form-left">
				<div class="input-group ">
					...
					<label class="input-label">角色名称：</label> <input id="name"
						name="name" type="text" class="input" value="${profession.name }" maxlength="20"
						placeholder="请输入职业名称！" autofocus>
				</div>
			</div>
		</div>
	...
	$(function() {
		...
		$userform.on("submit", function(e) {
			...
			$this.ajaxSubmit({
				...
				success : function() {
					// 刷新页面
					$("body").find(".profession").trigger("click");
				}
			})
		});
	});
